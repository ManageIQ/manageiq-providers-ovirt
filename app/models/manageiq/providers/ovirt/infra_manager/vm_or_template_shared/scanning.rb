module ManageIQ::Providers::Ovirt::InfraManager::VmOrTemplateShared::Scanning
  ...
  def scan_job_class
    ManageIQ::Providers::Ovirt::InfraManager::Scanning::Job
  end
  ...
  def connect_to_ems(ost)
    ...
    begin
      ost.miqRhevm = ManageIQ::Providers::Ovirt::Inventory::Collector.new(ext_management_system, nil)
