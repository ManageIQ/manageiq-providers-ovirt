describe ManageIQ::Providers::Ovirt::InfraManager::ProvisionWorkflow::DialogFieldValidation do
  ...
  describe '.validate_disks_configuration' do
    before do
      ...
      @src_ems_id = @ems.id
      @workflow = ManageIQ::Providers::Ovirt::InfraManager::ProvisionWorkflow.new(values, admin)
    end
