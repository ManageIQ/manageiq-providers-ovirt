...
describe ManageIQ::Providers::Ovirt::InfraManager::Refresher do
  ...
  it "will perform a full refresh on v4.1" do
    ...
    # File.write('spec/vcr_cassettes/manageiq/providers/ovirt/infra_manager/refresh/tmp1.yml', rec_mod.yml.to_yaml)
    # @rec_yml = YAML.load_file('spec/vcr_cassettes/manageiq/providers/ovirt/infra_manager/refresh/tmp1.yml')
