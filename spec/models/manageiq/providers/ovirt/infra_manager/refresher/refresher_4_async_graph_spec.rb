...
describe ManageIQ::Providers::Ovirt::InfraManager::Refresher do
  ...
  def assert_specific_cluster
    ...
    expect(@default_rp).to have_attributes(
      ...
      :type                  => "ManageIQ::Providers::Ovirt::InfraManager::ResourcePool",
  ...
  def assert_specific_storage
    ...
    expect(@storage).to have_attributes(
      ...
      :name                          => "data_spider_1",
      :type                          => "ManageIQ::Providers::Ovirt::InfraManager::Storage",
      :store_type                    => "NFS",
    ...
    def assert_specific_host
      @host = ManageIQ::Providers::Ovirt::InfraManager::Host.find_by(:name => "bodh1")
    ...
    def assert_specific_vm_powered_on
      v = ManageIQ::Providers::Ovirt::InfraManager::Vm.find_by(:name => "vm_on")
    ...
    def assert_specific_vm_powered_off
      v = ManageIQ::Providers::Ovirt::InfraManager::Vm.find_by(:name => "vm_off")
      expect(v).to have_attributes(
        :template              => false,
        :ems_ref               => "/api/vms/8070fa6d-5b82-412c-9d41-a00017205c73",
        :uid_ems               => "8070fa6d-5b82-412c-9d41-a00017205c73",
    ...
    def assert_specific_template
      v = ManageIQ::Providers::Ovirt::InfraManager::Template.find_by(:name => "template_cd1")
      expect(v).to have_attributes(
        :template              => true,
    ...
    def assert_relationship_tree
      expect(@ems.descendants_arranged).to match_relationship_tree(
        [ManageIQ::Providers::Ovirt::InfraManager::Folder, "Datacenters", {:hidden=>true}] => {
          [ManageIQ::Providers::Ovirt::InfraManager::Datacenter, "Newd"] => {
            [ManageIQ::Providers::Ovirt::InfraManager::Folder, "host", {:hidden=>true}] => {
              [ManageIQ::Providers::Ovirt::InfraManager::Cluster, "newc"] => {
                [ManageIQ::Providers::Ovirt::InfraManager::ResourcePool, "Default for Cluster newc"] => {}
              }
            }, [ManageIQ::Providers::Ovirt::InfraManager::Folder, "vm", {:hidden=>true}] => {}
          }, [ManageIQ::Providers::Ovirt::InfraManager::Datacenter, "newd1"] => {
            [ManageIQ::Providers::Ovirt::InfraManager::Folder, "host", {:hidden=>true}] => {
              [ManageIQ::Providers::Ovirt::InfraManager::Cluster, "newd1_cluster"] => {
                [ManageIQ::Providers::Ovirt::InfraManager::ResourcePool, "Default for Cluster newd1_cluster"] => {
                  [ManageIQ::Providers::Ovirt::InfraManager::Vm, "vm_off"] => {}, [ManageIQ::Providers::Ovirt::InfraManager::Vm, "vm_on"] => {}
                }
              },
            }, [ManageIQ::Providers::Ovirt::InfraManager::Folder, "vm", {:hidden=>true}] => {
              [ManageIQ::Providers::Ovirt::InfraManager::Template, "template_cd1"] => {}, [ManageIQ::Providers::Ovirt::InfraManager::Template, "template_cd2"] => {}, [ManageIQ::Providers::Ovirt::InfraManager::Vm, "vm_off"] => {}, [ManageIQ::Providers::Ovirt::InfraManager::Vm, "vm_on"] => {}
            }
          }
        }
      )
