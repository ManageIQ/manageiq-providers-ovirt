describe ManageIQ::Providers::Ovirt::InfraManager::Provision::Configuration::Network do
  ...
  let(:target_vm)     { FactoryBot.create(:vm_ovirt, :ext_management_system => ems) }

  before do
    @task = FactoryBot.create(:miq_provision_ovirt,
                               :source      => template,
