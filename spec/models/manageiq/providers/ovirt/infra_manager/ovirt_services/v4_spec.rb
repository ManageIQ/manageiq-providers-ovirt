describe ManageIQ::Providers::Ovirt::InfraManager::OvirtServices::V4 do
  ...
  describe "#vm_reconfigure" do
    ...
    let(:vm) do
      FactoryBot.create(:vm_ovirt, :ext_management_system => ems).tap do |v|
    ...
    describe 'add network adapters' do
      ...
      context 'errors' do
        ...
        it 'already existing nic' do
          ...
          expect { subject }.to raise_error(ManageIQ::Providers::Ovirt::InfraManager::OvirtServices::Error,
    ...
    context "#start_clone" do
      before do
        ...
        @ovirt_services = ManageIQ::Providers::Ovirt::InfraManager::OvirtServices::V4.new(:ems => @ems)
        ...
        rhevm_template = ManageIQ::Providers::Ovirt::InfraManager::
